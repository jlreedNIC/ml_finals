...
print('loading model...')
model = Keras_Custom_Model(model=None, model_name="fcnn")
...
# point_cloud = load_points_from_stl("data/headphones_noise.stl", True) 
point_cloud = load_points_from_stl("data/tv_remote_noise.stl", True) 
...
# # -------------
# # looping through all models and all files
# model_list = [
#     "models/keras_checkpoint_fully_connected_nn_batch2.keras", 
#     "models/keras_checkpoint_fully_connected_nn_custom_layers.keras", 
#     "models/keras_checkpoint_pointnet_trainbatch2.keras", 
#     "models/keras_checkpoint_cnn_onehot3.keras"]
# model_names = [
#     "fcnn",
#     "fcnn_custom",
#     "pointnet",
...
# ]
# data_files = [
#     "data/headphones_noise.stl",
#     "data/tv_remote_noise.stl"
# ]

# for i in range(len(model_list)):
#     print(f'running model: {model_names[i]}')
#     model = Keras_Custom_Model(model=None, model_name=model_names[i])
#     model.load_keras_model(model_list[i])

#     for j in range(len(data_files)):
#         print(f'---- on file: {data_files[j]}')
#         point_cloud = load_points_from_stl(data_files[j])
